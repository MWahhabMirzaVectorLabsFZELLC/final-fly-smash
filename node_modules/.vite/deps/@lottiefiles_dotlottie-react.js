import {
  require_react
} from "./chunk-W5WM7KBI.js";
import "./chunk-4KWLJ3MI.js";
import {
  __toESM
...
var t0 = Object.defineProperties;
...
var o2 = (v, n, i) => n in v ? e0(v, n, { enumerable: true, configurable: true, writable: true, value: i }) : v[n] = i;
var k = (v, n) => {
  for (var i in n || (n = {}))
    e3.call(n, i) && o2(v, i, n[i]);
  if (k1)
    for (var i of k1(n))
      t3.call(n, i) && o2(v, i, n[i]);
  return v;
};
var z = (v, n) => t0(v, n0(n));
var R1 = (v, n) => {
  var i = {};
  for (var o in v)
    e3.call(v, o) && n.indexOf(o) < 0 && (i[o] = v[o]);
  if (v != null && k1)
    for (var o of k1(v))
      n.indexOf(o) < 0 && t3.call(v, o) && (i[o] = v[o]);
  return i;
};
var g = (v, n, i) => o2(v, typeof n != "symbol" ? n + "" : n, i);
var b = (v, n, i) => new Promise((o, p) => {
  var _ = (x) => {
    try {
      P(i.next(x));
    } catch (S) {
  ...
  }, P = (x) => x.done ? o(x.value) : Promise.resolve(x.value).then(_, F);
  P((i = i.apply(v, n)).next());
});
var s2 = class {
...
var d2 = class {
  constructor() {
    g(this, "_lastHandleId", 0);
    g(this, "_lastImmediate", null);
  }
  requestAnimationFrame(n) {
...
var O1 = class {
  constructor() {
    g(this, "_strategy");
    this._strategy = typeof requestAnimationFrame == "function" ? new s2() : new d2();
  }
  requestAnimationFrame(n) {
...
var $1 = new Uint8Array([80, 75, 3, 4]);
var n3 = ["v", "ip", "op", "layers", "fr", "w", "h"];
var u2 = "0.34.0";
var l2 = "@lottiefiles/dotlottie-web";
var r3 = 0.75;
var r0 = (() => {
  var n;
  var v = typeof document != "undefined" ? (n = document.currentScript) == null ? void 0 : n.src : void 0;
  return function(i = {}) {
    var o = i, p, _, F = new Promise((e, t) => {
      p = e, _ = t;
    }), P = Object.assign({}, o), x = "./this.program", S = "";
    typeof document != "undefined" && document.currentScript && (S = document.currentScript.src), v && (S = v), S.startsWith("blob:") ? S = "" : S = S.substr(0, S.replace(/[?#].*/, "").lastIndexOf("/") + 1);
    var M1 = o.print || console.log.bind(console), q = o.printErr || console.error.bind(console);
    Object.assign(o, P), P = null, o.thisProgram && (x = o.thisProgram);
    var Z;
    o.wasmBinary && (Z = o.wasmBinary);
    var C1, g2 = false, t1, T, s1, c1, $, I, y2, w2;
    function b2() {
      var e = C1.buffer;
      o.HEAP8 = t1 = new Int8Array(e), o.HEAP16 = s1 = new Int16Array(e), o.HEAPU8 = T = new Uint8Array(e), o.HEAPU16 = c1 = new Uint16Array(e), o.HEAP32 = $ = new Int32Array(e), o.HEAPU32 = I = new Uint32Array(e), o.HEAPF32 = y2 = new Float32Array(e), o.HEAPF64 = w2 = new Float64Array(e);
    }
    var M2 = [], C2 = [], L2 = [];
    function h3() {
    ...
    function L1(e) {
      var t;
      throw (t = o.onAbort) == null || t.call(o, e), e = "Aborted(" + e + ")", q(e), g2 = true, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), _(e), e;
    }
    var E22 = (e) => e.startsWith("data:application/octet-stream;base64,"), d1;
    if (d1 = "DotLottiePlayer.wasm", !E22(d1)) {
      var P2 = d1;
      d1 = o.locateFile ? o.locateFile(P2, S) : S + P2;
    }
    function S2(e) {
      if (e == d1 && Z)
    ...
    function p3(e) {
      return Z || typeof fetch != "function" ? Promise.resolve().then(() => S2(e)) : fetch(e, { credentials: "same-origin" }).then((t) => {
        if (!t.ok)
    ...
    function I2(e, t, r) {
      return p3(e).then((a) => WebAssembly.instantiate(a, t)).then(r, (a) => {
        q(`failed to asynchronously prepare wasm: ${a}`), L1(a);
      });
    }
    function v3(e, t) {
      var r = d1;
      return Z || typeof WebAssembly.instantiateStreaming != "function" || E22(r) || typeof fetch != "function" ? I2(r, e, t) : fetch(r, { credentials: "same-origin" }).then((a) => WebAssembly.instantiateStreaming(a, e).then(t, function(s) {
        return q(`wasm streaming compile failed: ${s}`), q("falling back to ArrayBuffer instantiation"), I2(r, e, t);
      }));
    }
    var B1 = (e) => {
      for (; 0 < e.length; )
        e.shift()(o);
    }, F2 = typeof TextDecoder != "undefined" ? new TextDecoder("utf8") : void 0, r1 = (e, t, r) => {
      var a = t + r;
      for (r = t; e[r] && !(r >= a); )
        ++r;
      ...
      for (a = ""; t < r; ) {
        ...
        if (s & 128) {
          var d = e[t++] & 63;
          if ((s & 224) == 192)
            a += String.fromCharCode((s & 31) << 6 | d);
          else {
            var c = e[t++] & 63;
            s = (s & 240) == 224 ? (s & 15) << 12 | d << 6 | c : (s & 7) << 18 | d << 12 | c << 6 | e[t++] & 63, 65536 > s ? a += String.fromCharCode(s) : (s -= 65536, a += String.fromCharCode(55296 | s >> 10, 56320 | s & 1023));
          }
        } else
    ...
    var x2 = 0, T2 = (e) => {
      for (var t = 0, r = 0; r < e.length; ++r) {
        ...
        127 >= a ? t++ : 2047 >= a ? t += 2 : 55296 <= a && 57343 >= a ? (t += 4, ++r) : t += 3;
      }
      return t;
    }, A2 = (e, t, r, a) => {
      if (0 < a) {
    ...
    var u1 = {}, i1 = {}, P1 = {}, v1, Q = (e, t, r) => {
      function a(l) {
        if (l = r(l), l.length !== e.length)
          throw new v1("Mismatched type converter count");
      ...
      var s = Array(t.length), d = [], c = 0;
      t.forEach((l, f) => {
        i1.hasOwnProperty(l) ? s[f] = i1[l] : (d.push(l), u1.hasOwnProperty(l) || (u1[l] = []), u1[l].push(() => {
          s[f] = i1[l], ++c, c === d.length && a(s);
        }));
      }), d.length === 0 && a(s);
    }, D2, O = (e) => {
      for (var t = ""; T[e]; )
    ...
    function _3(e, t, r = {}) {
      var a = t.name;
      if (!e)
        throw new M(`type "${a}" must have a positive integer typeid pointer`);
      if (i1.hasOwnProperty(e)) {
        if (r.ib)
          return;
        throw new M(`Cannot register type '${a}' twice`);
      }
      i1[e] = t, delete P1[e], u1.hasOwnProperty(e) && (t = u1[e], delete u1[e], t.forEach((s) => s()));
    }
    function N(e, t, r = {}) {
    ...
    var H1 = (e) => {
      throw new M(e.ma.za.xa.name + " instance already deleted");
    }, N1 = false, k2 = () => {
    }, R2 = (e, t, r) => t === r ? e : r.Ca === void 0 ? null : (e = R2(e, t, r.Ca), e === null ? null : r.ab(e)), O2 = {}, f1 = [], V1 = () => {
      for (; f1.length; ) {
        var e = f1.pop();
      ...
      if (!t.za || !t.ya)
        throw new v1("makeClassHandle requires ptr and ptrType");
      if (!!t.Da != !!t.Aa)
        throw new v1("Both smartPtrType and smartPtr must be specified");
      return t.count = { value: 1 }, g1(Object.create(e, { ma: { value: t, writable: true } }));
    }, g1 = (e) => typeof FinalizationRegistry == "undefined" ? (g1 = (t) => t, e) : (N1 = new FinalizationRegistry((t) => {
      t = t.ma, --t.count.value, t.count.value === 0 && (t.Aa ? t.Da.Fa(t.Aa) : t.za.xa.Fa(t.ya));
    }), g1 = (t) => {
      var r = t.ma;
      return r.Aa && N1.register(t, { ma: r }, t), t;
    }, k2 = (t) => {
      N1.unregister(t);
    }, g1(e));
    function I1() {
    }
    var y1 = (e, t) => Object.defineProperty(t, "name", { value: e }), $2 = (e, t, r) => {
      if (e[t].Ba === void 0) {
        var a = e[t];
        e[t] = function(...s) {
          if (!e[t].Ba.hasOwnProperty(s.length))
            throw new M(`Function '${r}' called with an invalid number of arguments (${s.length}) - expects one of (${e[t].Ba})!`);
          return e[t].Ba[s.length].apply(this, s);
        }, e[t].Ba = [], e[t].Ba[a.Oa] = a;
      }
    }, Y1 = (e, t, r) => {
      if (o.hasOwnProperty(e)) {
        if (r === void 0 || o[e].Ba !== void 0 && o[e].Ba[r] !== void 0)
          throw new M(`Cannot register public name '${e}' twice`);
        if ($2(o, e, e), o.hasOwnProperty(r))
          throw new M(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
        o[e].Ba[r] = t;
      } else
        o[e] = t, r !== void 0 && (o[e].vb = r);
    }, y3 = (e) => {
      if (e === void 0)
        return "_unknown";
    ...
    function w3(e, t, r, a, s, d, c, l) {
      this.name = e, this.constructor = t, this.La = r, this.Fa = a, this.Ca = s, this.cb = d, this.Na = c, this.ab = l, this.kb = [];
    }
    var J1 = (e, t, r) => {
      for (; t !== r; ) {
        if (!t.Na)
          throw new M(`Expected null or instance of ${r.name}, got an instance of ${t.name}`);
        e = t.Na(e), t = t.Ca;
      }
      return e;
    };
    function b3(e, t) {
      ...
      if (!t.ma)
        throw new M(`Cannot pass "${e2(t)}" as a ${this.name}`);
      if (!t.ma.ya)
        throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return J1(t.ma.ya, t.ma.za.xa, this.xa);
    }
    function M3(e, t) {
      if (t === null) {
        if (this.Ta)
      ...
      if (!this.Pa && t.ma.za.Pa)
        throw new M(`Cannot convert argument of type ${t.ma.Da ? t.ma.Da.name : t.ma.za.name} to parameter type ${this.name}`);
      if (r = J1(t.ma.ya, t.ma.za.xa, this.xa), this.Qa) {
        if (t.ma.Aa === void 0)
        ...
        switch (this.pb) {
          ...
          case 2:
            if (t.ma.Da === this)
              ...
              var a = t.clone();
              r = this.lb(r, x1(() => a.delete())), e !== null && e.push(this.Fa, r);
            }
            break;
          default:
    ...
    function C3(e, t) {
      ...
      if (!t.ma.ya)
        throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (t.ma.za.Pa)
        throw new M(`Cannot convert argument of type ${t.ma.za.name} to parameter type ${this.name}`);
      return J1(t.ma.ya, t.ma.za.xa, this.xa);
    }
    function w1(e, t, r, a, s, d, c, l, f, h, m) {
      this.name = e, this.xa = t, this.Ta = r, this.Pa = a, this.Qa = s, this.jb = d, this.pb = c, this.Za = l, this.Ua = f, this.lb = h, this.Fa = m, s || t.Ca !== void 0 ? this.toWireType = M3 : (this.toWireType = a ? b3 : C3, this.Ea = null);
    }
    var z2 = (e, t, r) => {
      if (!o.hasOwnProperty(e))
        throw new v1("Replacing nonexistent public symbol");
      o[e].Ba !== void 0 && r !== void 0 ? o[e].Ba[r] = t : (o[e] = t, o[e].Oa = r);
    }, H, L3 = (e, t, r = []) => (e.includes("j") ? (e = e.replace(/p/g, "i"), t = (0, o["dynCall_" + e])(t, ...r)) : t = H.get(t)(...r), t), E3 = (e, t) => (...r) => L3(e, t, r), W = (e, t) => {
      e = O(e);
      var r = e.includes("j") ? E3(e, t) : H.get(t);
      if (typeof r != "function")
        throw new M(`unknown function pointer with signature ${e}: ${t}`);
      return r;
    }, W2, U2 = (e) => {
      e = q2(e);
      var t = O(e);
      ...
      function r(d) {
        s[d] || i1[d] || (P1[d] ? P1[d].forEach(r) : (a.push(d), s[d] = true));
      }
      var a = [], s = {};
      throw t.forEach(r), new W2(`${e}: ` + a.map(U2).join([", "]));
    }, G1 = (e, t) => {
      for (var r = [], a = 0; a < e; a++)
        r.push(I[t + 4 * a >> 2]);
      return r;
    ...
    function q1(e, t, r, a, s) {
      ...
      var c = t[1] !== null && r !== null, l = P3(t), f = t[0].name !== "void", h = d - 2, m = Array(h), C = [], L = [];
      return y1(e, function(...u) {
        if (u.length !== h)
          throw new M(`function ${e} called with ${u.length} arguments, expected ${h}`);
        if (L.length = 0, C.length = c ? 2 : 1, C[0] = s, c) {
          var y = t[1].toWireType(L, this);
          C[1] = y;
        }
        for (var w = 0; w < h; ++w)
          m[w] = t[w + 2].toWireType(L, u[w]), C.push(m[w]);
        if (u = a(...C), l)
          j1(L);
        else
          for (w = c ? 1 : 2; w < t.length; w++) {
            var D = w === 1 ? y : m[w - 2];
            t[w].Ea !== null && t[w].Ea(D);
          }
        return y = f ? t[0].fromWireType(u) : void 0, y;
      });
    }
    var B2 = (e) => {
      e = e.trim();
      ...
      9 < e && --K[e + 1] === 0 && (K[e] = void 0, K1.push(e));
    }, Z1 = (e) => {
      if (!e)
        throw new M("Cannot use deleted val. handle = " + e);
      return K[e];
    }, x1 = (e) => {
      switch (e) {
        case void 0:
        ...
        case false:
          return 8;
        default:
          let t = K1.pop() || K.length;
          return K[t] = e, K[t + 1] = 1, t;
      }
    }, j2 = { name: "emscripten::val", fromWireType: (e) => {
      var t = Z1(e);
      return X1(e), t;
    }, toWireType: (e, t) => x1(t), argPackAdvance: 8, readValueFromPointer: p1, Ea: null }, S3 = (e, t, r) => {
      switch (t) {
        case 1:
          return r ? function(a) {
            return this.fromWireType(t1[a]);
          } : function(a) {
        ...
        case 2:
          return r ? function(a) {
            ...
            return this.fromWireType(c1[a >> 1]);
          };
        case 4:
          return r ? function(a) {
      ...
      var r = i1[e];
      if (r === void 0)
        throw e = `${t} has unknown type ${U2(e)}`, new M(e);
      return r;
    }, e2 = (e) => {
      if (e === null)
        return "null";
      ...
      switch (t) {
        case 4:
          return function(r) {
            return this.fromWireType(y2[r >> 2]);
          };
        case 8:
          return function(r) {
            return this.fromWireType(w2[r >> 3]);
          };
        default:
      ...
      switch (t) {
        case 1:
          return r ? (a) => t1[a] : (a) => T[a];
        case 2:
          return r ? (a) => s1[a >> 1] : (a) => c1[a >> 1];
        case 4:
          return r ? (a) => $[a >> 2] : (a) => I[a >> 2];
        default:
          throw new TypeError(`invalid integer width (${t}): ${e}`);
      }
    }, H2 = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, x3 = (e, t) => {
      for (var r = e >> 1, a = r + t / 2; !(r >= a) && c1[r]; )
        ++r;
      if (r <<= 1, 32 < r - e && H2)
        return H2.decode(T.subarray(e, r));
      for (r = "", a = 0; !(a >= t / 2); ++a) {
        var s = s1[e + 2 * a >> 1];
        if (s == 0)
          break;
      ...
      for (var r = Array(e), a = 0; a < e; ++a)
        r[a] = Q1(I[t + 4 * a >> 2], "parameter " + a);
      return r;
    }, z3 = Reflect.construct, n2 = {}, N2 = () => {
      if (!r2) {
        var e = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: x || "./this.program" }, t;
        for (t in n2)
          n2[t] === void 0 ? delete e[t] : e[t] = n2[t];
        var r = [];
        for (t in e)
          r.push(`${t}=${e[t]}`);
        r2 = r;
      ...
      L1("initRandomDevice");
    }, V2 = (e) => (V2 = U3())(e), T1 = (e) => e % 4 === 0 && (e % 100 !== 0 || e % 400 === 0), Y2 = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], J2 = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
    function B3(e) {
      var t = Array(T2(e) + 1);
      return A2(e, t, 0, t.length), t;
    }
    var j3 = (e, t, r, a) => {
      function s(u, y, w) {
        for (u = typeof u == "number" ? u.toString() : u || ""; u.length < y; )
          u = w[0] + u;
        return u;
      }
      function d(u, y) {
      ...
      function c(u, y) {
        ...
        var D;
        return (D = w(u.getFullYear() - y.getFullYear())) === 0 && (D = w(u.getMonth() - y.getMonth())) === 0 && (D = w(u.getDate() - y.getDate())), D;
      }
      function l(u) {
        switch (u.getDay()) {
          case 0:
      ...
      function f(u) {
        var y = u.Ia;
        for (u = new Date(new Date(u.Ja + 1900, 0, 1).getTime()); 0 < y; ) {
          var w = u.getMonth(), D = (T1(u.getFullYear()) ? Y2 : J2)[w];
          if (y > D - u.getDate())
            y -= D - u.getDate() + 1, u.setDate(1), 11 > w ? u.setMonth(w + 1) : (u.setMonth(0), u.setFullYear(u.getFullYear() + 1));
          else {
            u.setDate(u.getDate() + y);
            break;
          }
        }
        return w = new Date(u.getFullYear() + 1, 0, 4), y = l(new Date(u.getFullYear(), 0, 4)), w = l(w), 0 >= c(y, u) ? 0 >= c(w, u) ? u.getFullYear() + 1 : u.getFullYear() : u.getFullYear() - 1;
      }
      var h = I[a + 40 >> 2];
      a = { sb: $[a >> 2], rb: $[a + 4 >> 2], Ra: $[a + 8 >> 2], Va: $[a + 12 >> 2], Sa: $[a + 16 >> 2], Ja: $[a + 20 >> 2], Ga: $[a + 24 >> 2], Ia: $[a + 28 >> 2], wb: $[a + 32 >> 2], qb: $[a + 36 >> 2], tb: h && h ? r1(T, h) : "" }, r = r ? r1(T, r) : "", h = { "%c": "%a %b %d %H:%M:%S %Y", "%D": "%m/%d/%y", "%F": "%Y-%m-%d", "%h": "%b", "%r": "%I:%M:%S %p", "%R": "%H:%M", "%T": "%H:%M:%S", "%x": "%m/%d/%y", "%X": "%H:%M:%S", "%Ec": "%c", "%EC": "%C", "%Ex": "%m/%d/%y", "%EX": "%H:%M:%S", "%Ey": "%y", "%EY": "%Y", "%Od": "%d", "%Oe": "%e", "%OH": "%H", "%OI": "%I", "%Om": "%m", "%OM": "%M", "%OS": "%S", "%Ou": "%u", "%OU": "%U", "%OV": "%V", "%Ow": "%w", "%OW": "%W", "%Oy": "%y" };
      for (var m in h)
        r = r.replace(new RegExp(m, "g"), h[m]);
      var C = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), L = "January February March April May June July August September October November December".split(" ");
      h = { "%a": (u) => C[u.Ga].substring(0, 3), "%A": (u) => C[u.Ga], "%b": (u) => L[u.Sa].substring(0, 3), "%B": (u) => L[u.Sa], "%C": (u) => d((u.Ja + 1900) / 100 | 0, 2), "%d": (u) => d(u.Va, 2), "%e": (u) => s(u.Va, 2, " "), "%g": (u) => f(u).toString().substring(2), "%G": f, "%H": (u) => d(u.Ra, 2), "%I": (u) => (u = u.Ra, u == 0 ? u = 12 : 12 < u && (u -= 12), d(u, 2)), "%j": (u) => {
        for (var y = 0, w = 0; w <= u.Sa - 1; y += (T1(u.Ja + 1900) ? Y2 : J2)[w++])
          ;
        return d(u.Va + y, 3);
      }, "%m": (u) => d(u.Sa + 1, 2), "%M": (u) => d(u.rb, 2), "%n": () => `
`, "%p": (u) => 0 <= u.Ra && 12 > u.Ra ? "AM" : "PM", "%S": (u) => d(u.sb, 2), "%t": () => "	", "%u": (u) => u.Ga || 7, "%U": (u) => d(Math.floor((u.Ia + 7 - u.Ga) / 7), 2), "%V": (u) => {
        var y = Math.floor((u.Ia + 7 - (u.Ga + 6) % 7) / 7);
        if (2 >= (u.Ga + 371 - u.Ia - 2) % 7 && y++, y)
          y == 53 && (w = (u.Ga + 371 - u.Ia) % 7, w == 4 || w == 3 && T1(u.Ja) || (y = 1));
        else {
          y = 52;
          var w = (u.Ga + 7 - u.Ia - 1) % 7;
          (w == 4 || w == 5 && T1(u.Ja % 400 - 1)) && y++;
        }
        return d(y, 2);
      }, "%w": (u) => u.Ga, "%W": (u) => d(Math.floor((u.Ia + 7 - (u.Ga + 6) % 7) / 7), 2), "%y": (u) => (u.Ja + 1900).toString().substring(2), "%Y": (u) => u.Ja + 1900, "%z": (u) => {
        u = u.qb;
        var y = 0 <= u;
        return u = Math.abs(u) / 60, (y ? "+" : "-") + ("0000" + (u / 60 * 100 + u % 60)).slice(-4);
      }, "%Z": (u) => u.tb, "%%": () => "%" }, r = r.replace(/%%/g, "\0\0");
      for (m in h)
        r.includes(m) && (r = r.replace(new RegExp(m, "g"), h[m](a)));
      return r = r.replace(/\0\0/g, "%"), m = B3(r), m.length > t ? 0 : (t1.set(m, e), m.length - 1);
    };
    v1 = o.InternalError = class extends Error {
      constructor(e) {
        super(e), this.name = "InternalError";
      }
    };
    for (var G22 = Array(256), A1 = 0; 256 > A1; ++A1)
      G22[A1] = String.fromCharCode(A1);
    D2 = G22, M = o.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Object.assign(I1.prototype, { isAliasOf: function(e) {
      if (!(this instanceof I1 && e instanceof I1))
        return false;
      ...
      if (this.ma.ya || H1(this), this.ma.Ma)
        return this.ma.count.value += 1, this;
      var e = g1, t = Object, r = t.create, a = Object.getPrototypeOf(this), s = this.ma;
      return e = e(r.call(t, a, { ma: { value: { count: s.count, Ka: s.Ka, Ma: s.Ma, ya: s.ya, za: s.za, Aa: s.Aa, Da: s.Da } } })), e.ma.count.value += 1, e.ma.Ka = false, e;
    }, delete() {
      if (this.ma.ya || H1(this), this.ma.Ka && !this.ma.Ma)
      ...
      if (this.ma.ya || H1(this), this.ma.Ka && !this.ma.Ma)
        throw new M("Object already scheduled for deletion");
      return f1.push(this), f1.length === 1 && m1 && m1(V1), this.ma.Ka = true, this;
    } }), o.getInheritedInstanceCount = () => Object.keys(_1).length, o.getLiveInheritedInstances = () => {
      var e = [], t;
      for (t in _1)
        _1.hasOwnProperty(t) && e.push(_1[t]);
      return e;
    }, o.flushPendingDeletes = V1, o.setDelayFunction = (e) => {
      m1 = e, f1.length && m1 && m1(V1);
    }, Object.assign(w1.prototype, { eb(e) {
      return this.Za && (e = this.Za(e)), e;
    }, Xa(e) {
      var t;
      (t = this.Fa) == null || t.call(this, e);
    }, argPackAdvance: 8, readValueFromPointer: p1, fromWireType: function(e) {
      function t() {
        return this.Qa ? S1(this.xa.La, { za: this.jb, ya: r, Da: this, Aa: e }) : S1(this.xa.La, { za: this, ya: e });
      }
      var r = this.eb(e);
      if (!r)
      ...
      var a = g3(this.xa, r);
      if (a !== void 0)
        return a.ma.count.value === 0 ? (a.ma.ya = r, a.ma.Aa = e, a.clone()) : (a = a.clone(), this.Xa(e), a);
      if (a = this.xa.cb(r), a = O2[a], !a)
        return t.call(this);
      a = this.Pa ? a.$a : a.pointerType;
      var s = R2(r, this.xa, a.xa);
      return s === null ? t.call(this) : this.Qa ? S1(a.xa.La, { za: a, ya: s, Da: this, Aa: e }) : S1(a.xa.La, { za: a, ya: s });
    } }), W2 = o.UnboundTypeError = ((e, t) => {
      var r = y1(t, function(a) {
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    })(Error, "UnboundTypeError"), K.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), o.count_emval_handles = () => K.length / 2 - 5 - K1.length;
    var H3 = { c: (e, t, r, a) => {
      L1(`Assertion failed: ${e ? r1(T, e) : ""}, at: ` + [t ? t ? r1(T, t) : "" : "unknown filename", r, a ? a ? r1(T, a) : "" : "unknown function"]);
    }, m: (e, t, r) => {
      var a = new f3(e);
      throw I[a.ya + 16 >> 2] = 0, I[a.ya + 4 >> 2] = t, I[a.ya + 8 >> 2] = r, x2 = e, x2;
    }, B: function() {
      return 0;
    }, P: () => {
    }, M: () => {
      ...
      var t = E1[e];
      delete E1[e];
      var r = t.Ua, a = t.Fa, s = t.Ya, d = s.map((c) => c.hb).concat(s.map((c) => c.nb));
      Q([e], d, (c) => {
        var l = {};
        return s.forEach((f, h) => {
          var m = c[h], C = f.fb, L = f.gb, u = c[h + s.length], y = f.mb, w = f.ob;
          l[f.bb] = { read: (D) => m.fromWireType(C(L, D)), write: (D, e1) => {
            var j = [];
            y(w, D, u.toWireType(j, e1)), j1(j);
          } };
          ...
          for (m in l)
            l[m].write(C, h[m]);
          return f !== null && f.push(a, C), C;
        }, argPackAdvance: 8, readValueFromPointer: p1, Ea: a }];
      });
    }, I: () => {
    }, Y: (e, t, r, a) => {
      t = O(t), N(e, { name: t, fromWireType: function(s) {
        return !!s;
      }, toWireType: function(s, d) {
        return d ? r : a;
      }, argPackAdvance: 8, readValueFromPointer: function(s) {
        return this.fromWireType(T[s]);
      }, Ea: null });
    }, r: (e, t, r, a, s, d, c, l, f, h, m, C, L) => {
      m = O(m), d = W(s, d), l && (l = W(c, l)), h && (h = W(f, h)), L = W(C, L);
      var u = y3(m);
      Y1(u, function() {
        F1(`Cannot construct ${m} due to unbound types`, [a]);
      }), Q([e, t, r], a ? [a] : [], (y) => {
        if (y = y[0], a)
          var w = y.xa, D = w.La;
        else
          D = I1.prototype;
        y = y1(m, function(...a2) {
          if (Object.getPrototypeOf(this) !== e1)
            throw new M("Use 'new' to construct " + m);
          if (j.Ha === void 0)
            throw new M(m + " has no accessible constructor");
          var Q2 = j.Ha[a2.length];
          if (Q2 === void 0)
            throw new M(`Tried to invoke ctor of ${m} with invalid number of parameters (${a2.length}) - expected (${Object.keys(j.Ha).toString()}) parameters instead!`);
          return Q2.apply(this, a2);
        });
        var e1 = Object.create(D, { constructor: { value: y } });
        y.prototype = e1;
        var j = new w3(m, y, e1, L, w, d, l, h);
        if (j.Ca) {
          var b1;
          (b1 = j.Ca).Wa != null || (b1.Wa = []), j.Ca.Wa.push(j);
        }
        return w = new w1(m, j, true, false, false), b1 = new w1(m + "*", j, false, false, false), D = new w1(m + " const*", j, false, true, false), O2[e] = { pointerType: b1, $a: D }, z2(u, y), [w, b1, D];
      });
    }, q: (e, t, r, a, s, d) => {
      var c = G1(t, r);
      s = W(a, s), Q([], [e], (l) => {
        ...
        if (l.xa.Ha === void 0 && (l.xa.Ha = []), l.xa.Ha[t - 1] !== void 0)
          throw new M(`Cannot register multiple constructors with identical number of parameters (${t - 1}) for class '${l.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return l.xa.Ha[t - 1] = () => {
          F1(`Cannot construct ${l.name} due to unbound types`, c);
        }, Q([], c, (h) => (h.splice(1, 0, null), l.xa.Ha[t - 1] = q1(f, h, null, s, d), [])), [];
      });
    }, f: (e, t, r, a, s, d, c, l) => {
      var f = G1(r, a);
      t = O(t), t = B2(t), d = W(s, d), Q([], [e], (h) => {
        function m() {
          F1(`Cannot call ${C} due to unbound types`, f);
        }
        h = h[0];
        var C = `${h.name}.${t}`;
        t.startsWith("@@") && (t = Symbol[t.substring(2)]), l && h.xa.kb.push(t);
        var L = h.xa.La, u = L[t];
        return u === void 0 || u.Ba === void 0 && u.className !== h.name && u.Oa === r - 2 ? (m.Oa = r - 2, m.className = h.name, L[t] = m) : ($2(L, t, C), L[t].Ba[r - 2] = m), Q([], f, (y) => (y = q1(C, y, h, d, c), L[t].Ba === void 0 ? (y.Oa = r - 2, L[t] = y) : L[t].Ba[r - 2] = y, [])), [];
      });
    }, X: (e) => N(e, j2), x: (e, t, r, a) => {
      function s() {
      }
      t = O(t), s.values = {}, N(e, { name: t, constructor: s, fromWireType: function(d) {
        return this.constructor.values[d];
      }, toWireType: (d, c) => c.value, argPackAdvance: 8, readValueFromPointer: S3(t, r, a), Ea: null }), Y1(t, s);
    }, k: (e, t, r) => {
      var a = Q1(e, "enum");
      t = O(t), e = a.constructor, a = Object.create(a.constructor.prototype, { value: { value: r }, constructor: { value: y1(`${a.name}_${t}`, function() {
      }) } }), e.values[r] = a, e[t] = a;
    }, C: (e, t, r) => {
      t = O(t), N(e, { name: t, fromWireType: (a) => a, toWireType: (a, s) => s, argPackAdvance: 8, readValueFromPointer: I3(t, r), Ea: null });
    }, E: (e, t, r, a, s, d) => {
      var c = G1(t, r);
      e = O(e), e = B2(e), s = W(a, s), Y1(e, function() {
        F1(`Cannot call ${e} due to unbound types`, c);
      }, t - 1), Q([], c, (l) => (z2(e, q1(e, [l[0], null].concat(l.slice(1)), null, s, d), t - 1), []));
    }, l: (e, t, r, a, s) => {
      if (t = O(t), s === -1 && (s = 4294967295), s = (l) => l, a === 0) {
        var d = 32 - 8 * r;
        s = (l) => l << d >>> d;
      }
      var c = t.includes("unsigned") ? function(l, f) {
        return f >>> 0;
      } : function(l, f) {
        return f;
      };
      N(e, { name: t, fromWireType: s, toWireType: c, argPackAdvance: 8, readValueFromPointer: F3(t, r, a !== 0), Ea: null });
    }, g: (e, t, r) => {
      function a(d) {
        return new s(t1.buffer, I[d + 4 >> 2], I[d >> 2]);
      }
      var s = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][t];
      r = O(r), N(e, { name: r, fromWireType: a, argPackAdvance: 8, readValueFromPointer: a }, { ib: true });
    }, w: (e) => {
      N(e, j2);
    }, ca: (e, t, r, a, s, d, c, l, f, h, m, C) => {
      r = O(r), d = W(s, d), l = W(c, l), h = W(f, h), C = W(m, C), Q([e], [t], (L) => (L = L[0], [new w1(r, L.xa, false, false, true, L, a, d, l, h, C)]));
    }, D: (e, t) => {
      t = O(t);
      var r = t === "std::string";
      N(e, { name: t, fromWireType: function(a) {
        var s = I[a >> 2], d = a + 4;
        if (r)
          for (var c = d, l = 0; l <= s; ++l) {
            var f = d + l;
            if (l == s || T[f] == 0) {
              if (c = c ? r1(T, c, f - c) : "", h === void 0)
                var h = c;
              else
                h += "\0", h += c;
              c = f + 1;
          ...
          for (h = Array(s), l = 0; l < s; ++l)
            h[l] = String.fromCharCode(T[d + l]);
          h = h.join("");
        }
        return X(a), h;
      }, toWireType: function(a, s) {
        s instanceof ArrayBuffer && (s = new Uint8Array(s));
        var d = typeof s == "string";
        if (!(d || s instanceof Uint8Array || s instanceof Uint8ClampedArray || s instanceof Int8Array))
          throw new M("Cannot pass non-string to std::string");
        var c = r && d ? T2(s) : s.length, l = i2(4 + c + 1), f = l + 4;
        if (I[l >> 2] = c, r && d)
          A2(s, T, f, c + 1);
        else if (d)
          for (d = 0; d < c; ++d) {
            ...
            if (255 < h)
              throw X(f), new M("String has UTF-16 code units that do not fit in 8 bits");
            T[f + d] = h;
          }
        else
          for (d = 0; d < c; ++d)
      ...
      if (r = O(r), t === 2)
        var a = x3, s = T3, d = A3, c = (l) => c1[l >> 1];
      else
        t === 4 && (a = D3, s = k3, d = R3, c = (l) => I[l >> 2]);
      N(e, { name: r, fromWireType: (l) => {
        for (var f = I[l >> 2], h, m = l + 4, C = 0; C <= f; ++C) {
          var L = l + 4 + C * t;
          (C == f || c(L) == 0) && (m = a(m, L - m), h === void 0 ? h = m : (h += "\0", h += m), m = L + t);
        }
        return X(l), h;
      }, toWireType: (l, f) => {
        if (typeof f != "string")
          throw new M(`Cannot pass non-string to C++ string type ${r}`);
        var h = d(f), m = i2(4 + h + t);
        return I[m >> 2] = h / t, s(f, m + 4, h + t), l !== null && l.push(X, m), m;
      }, argPackAdvance: 8, readValueFromPointer: p1, Ea(l) {
        X(l);
      } });
    }, s: (e, t, r, a, s, d) => {
      E1[e] = { name: O(t), Ua: W(r, a), Fa: W(s, d), Ya: [] };
    }, j: (e, t, r, a, s, d, c, l, f, h) => {
      E1[e].Ya.push({ bb: O(t), hb: r, fb: W(a, s), gb: d, nb: c, mb: W(l, f), ob: h });
    }, Z: (e, t) => {
      t = O(t), N(e, { ub: true, name: t, argPackAdvance: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, J: () => {
      throw 1 / 0;
    }, aa: (e, t, r, a) => (e = t2[e], t = Z1(t), e(null, t, r, a)), F: X1, $: (e, t, r) => {
      var a = $3(e, t), s = a.shift();
      e--;
      var d = Array(e);
      return t = `methodCaller<(${a.map((c) => c.name).join(", ")}) => ${s.name}>`, O3(y1(t, (c, l, f, h) => {
        for (var m = 0, C = 0; C < e; ++C)
          d[C] = a[C].readValueFromPointer(h + m), m += a[C].argPackAdvance;
        return l = r === 1 ? z3(l, d) : l.apply(c, d), c = [], l = s.toWireType(c, l), c.length && (I[f >> 2] = x1(c)), l;
      }));
    }, ba: (e) => {
      9 < e && (K[e + 1] += 1);
    }, _: (e) => {
      var t = Z1(e);
      j1(t), X1(e);
    }, o: (e, t) => (e = Q1(e, "_emval_take_value"), e = e.readValueFromPointer(t), x1(e)), W: () => {
      L1("");
      ...
      for (var r = 1; 4 >= r; r *= 2) {
        ...
        a = Math.max(e, a);
        e: {
          s = (s.min.call(s, 2147483648, a + (65536 - a % 65536) % 65536) - C1.buffer.byteLength + 65535) / 65536;
          try {
            C1.grow(s), b2();
            var d = 1;
            break e;
      ...
      var r = 0;
      return N2().forEach((a, s) => {
        var d = t + r;
        for (s = I[e + 4 * s >> 2] = d, d = 0; d < a.length; ++d)
          t1[s++] = a.charCodeAt(d);
        t1[s] = 0, r += a.length + 1;
      }), 0;
    }, T: (e, t) => {
      ...
      for (var s = 0, d = 0; d < r; d++) {
        var c = I[t >> 2], l = I[t + 4 >> 2];
        t += 8;
        for (var f = 0; f < l; f++) {
          var h = T[c + f], m = W3[e];
          h === 0 || h === 10 ? ((e === 1 ? M1 : q)(r1(m, 0)), m.length = 0) : m.push(h);
        }
        s += l;
      }
      return I[a >> 2] = s, 0;
    }, U: (e, t) => (V2(T.subarray(e, e + t)), 0), i: G3, d: J3, e: Y3, p: q3, y: Z3, b: N3, a: V3, h: X3, n: K3, G: Q3, K: (e, t, r, a) => j3(e, t, r, a) }, A = function() {
      var r;
      function e(a) {
        var s;
        return A = a.exports, C1 = A.da, b2(), H = A.ha, C2.unshift(A.ea), n1--, (s = o.monitorRunDependencies) == null || s.call(o, n1), n1 == 0 && (h1 && (a = h1, h1 = null, a())), A;
      }
      var t = { a: H3 };
      if (n1++, (r = o.monitorRunDependencies) == null || r.call(o, n1), o.instantiateWasm)
        try {
          return o.instantiateWasm(t, e);
        } catch (a) {
          q(`Module.instantiateWasm callback failed with error: ${a}`), _(a);
        }
      return v3(t, function(a) {
        e(a.instance);
      }).catch(_), {};
    }(), i2 = (e) => (i2 = A.fa)(e), q2 = (e) => (q2 = A.ga)(e), X = (e) => (X = A.ia)(e), V = (e, t) => (V = A.ja)(e, t), Y = (e) => (Y = A.ka)(e), J = () => (J = A.la)();
    o.dynCall_iijj = (e, t, r, a, s, d) => (o.dynCall_iijj = A.na)(e, t, r, a, s, d), o.dynCall_vijj = (e, t, r, a, s, d) => (o.dynCall_vijj = A.oa)(e, t, r, a, s, d), o.dynCall_jiii = (e, t, r, a) => (o.dynCall_jiii = A.pa)(e, t, r, a), o.dynCall_jii = (e, t, r) => (o.dynCall_jii = A.qa)(e, t, r);
    var K2 = o.dynCall_viiij = (e, t, r, a, s, d) => (K2 = o.dynCall_viiij = A.ra)(e, t, r, a, s, d);
    o.dynCall_jiji = (e, t, r, a, s) => (o.dynCall_jiji = A.sa)(e, t, r, a, s), o.dynCall_viijii = (e, t, r, a, s, d, c) => (o.dynCall_viijii = A.ta)(e, t, r, a, s, d, c), o.dynCall_iiiiij = (e, t, r, a, s, d, c) => (o.dynCall_iiiiij = A.ua)(e, t, r, a, s, d, c), o.dynCall_iiiiijj = (e, t, r, a, s, d, c, l, f) => (o.dynCall_iiiiijj = A.va)(e, t, r, a, s, d, c, l, f), o.dynCall_iiiiiijj = (e, t, r, a, s, d, c, l, f, h) => (o.dynCall_iiiiiijj = A.wa)(e, t, r, a, s, d, c, l, f, h);
    function N3(e, t) {
      var r = J();
      try {
        H.get(e)(t);
    ...
    function q3(e, t, r, a, s, d) {
      var c = J();
      try {
        return H.get(e)(t, r, a, s, d);
      } catch (l) {
        if (Y(c), l !== l + 0)
          throw l;
        V(1, 0);
    ...
    function X2() {
      function e() {
        if (!D1 && (D1 = true, o.calledRun = true, !g2)) {
          if (B1(C2), p(o), o.onRuntimeInitialized && o.onRuntimeInitialized(), o.postRun)
            for (typeof o.postRun == "function" && (o.postRun = [o.postRun]); o.postRun.length; ) {
              var t = o.postRun.shift();
              L2.unshift(t);
            }
          B1(L2);
        }
      ...
      if (!(0 < n1)) {
        if (o.preRun)
          for (typeof o.preRun == "function" && (o.preRun = [o.preRun]); o.preRun.length; )
            h3();
        B1(M2), 0 < n1 || (o.setStatus ? (o.setStatus("Running..."), setTimeout(function() {
          setTimeout(function() {
            o.setStatus("");
          }, 1), e();
        }, 1)) : e());
    ...
    if (o.preInit)
      for (typeof o.preInit == "function" && (o.preInit = [o.preInit]); 0 < o.preInit.length; )
        o.preInit.pop()();
    return X2(), F;
  };
})();
...
var a1 = class {
  ...
  static _loadWithBackup() {
    return b(this, null, function* () {
      return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch((n) => b(this, null, function* () {
        let i = `https://unpkg.com/${l2}@${u2}/dist/dotlottie-player.wasm`;
        ...
        try {
          ...
          throw console.error(`Primary WASM URL failed: ${n.message}`), console.error(`Backup WASM URL failed: ${o.message}`), new Error("WASM loading failed from all sources.");
        }
      }))), this._ModulePromise;
    });
  }
...
g(a1, "_ModulePromise", null), g(a1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${l2}@${u2}/dist/dotlottie-player.wasm`);
var l1 = class {
  constructor() {
    g(this, "_eventListeners", /* @__PURE__ */ new Map());
  }
  addEventListener(n, i) {
    let o = this._eventListeners.get(n);
    o || (o = /* @__PURE__ */ new Set(), this._eventListeners.set(n, o)), o.add(i);
  }
  removeEventListener(n, i) {
    let o = this._eventListeners.get(n);
    o && (i ? (o.delete(i), o.size === 0 && this._eventListeners.delete(n)) : this._eventListeners.delete(n));
  }
  dispatch(n) {
    let i = this._eventListeners.get(n.type);
    i == null || i.forEach((o) => o(n));
  }
...
var U = class {
  static _initializeObserver() {
    ...
    let n = (i) => {
      i.forEach((o) => {
        let p = this._observedCanvases.get(o.target);
        p && (o.isIntersecting ? p.unfreeze() : p.freeze());
      });
    };
  ...
  static observe(n, i) {
    var o;
    this._initializeObserver(), !this._observedCanvases.has(n) && (this._observedCanvases.set(n, i), (o = this._observer) == null || o.observe(n));
  }
  static unobserve(n) {
    var i, o;
    (i = this._observer) == null || i.unobserve(n), this._observedCanvases.delete(n), this._observedCanvases.size === 0 && ((o = this._observer) == null || o.disconnect(), this._observer = null);
  }
};
g(U, "_observer", null), g(U, "_observedCanvases", /* @__PURE__ */ new Map());
var B = class {
  static _initializeObserver() {
    if (this._observer)
      return;
    let n = (i) => {
      i.forEach((o) => {
        ...
        this._observedCanvases.set(o.target, [_, P]);
      });
    };
  ...
  static observe(n, i) {
    var o;
    this._initializeObserver(), !this._observedCanvases.has(n) && (this._observedCanvases.set(n, [i, 0]), (o = this._observer) == null || o.observe(n));
  }
  static unobserve(n) {
    var i, o;
    (i = this._observer) == null || i.unobserve(n), this._observedCanvases.delete(n), this._observedCanvases.size === 0 && ((o = this._observer) == null || o.disconnect(), this._observer = null);
...
g(B, "_observer", null), g(B, "_observedCanvases", /* @__PURE__ */ new Map());
function i0(v) {
  return /^#([\da-f]{6}|[\da-f]{8})$/iu.test(v);
}
function o3(v) {
  if (!i0(v))
    return 0;
...
function c2(v) {
  if (v.byteLength < 4)
    return false;
  let n = new Uint8Array(v.slice(0, $1.byteLength));
...
function a3(v) {
  return n3.every((n) => Object.prototype.hasOwnProperty.call(v, n));
}
function h2(v) {
  if (typeof v == "string")
    try {
      return a3(JSON.parse(v));
    } catch (n) {
      return false;
    }
  else
...
function o1() {
  return 1 + ((R ? window.devicePixelRatio : 1) - 1) * r3;
}
function z1(v) {
...
var p2 = (v, n) => v === "reverse" ? n.Mode.Reverse : v === "bounce" ? n.Mode.Bounce : v === "reverse-bounce" ? n.Mode.ReverseBounce : n.Mode.Forward;
var v2 = (v, n) => v === "contain" ? n.Fit.Contain : v === "cover" ? n.Fit.Cover : v === "fill" ? n.Fit.Fill : v === "fit-height" ? n.Fit.FitHeight : v === "fit-width" ? n.Fit.FitWidth : n.Fit.None;
var f2 = (v, n) => {
  let i = new n.VectorFloat();
  return i.push_back(v[0]), i.push_back(v[1]), i;
};
var m2 = (v, n) => {
  let i = new n.VectorFloat();
  return v.length !== 2 || (i.push_back(v[0]), i.push_back(v[1])), i;
};
var E = class E2 {
  constructor(n) {
    g(this, "_canvas");
    g(this, "_context", null);
    g(this, "_eventManager");
    g(this, "_animationFrameId", null);
    g(this, "_frameManager");
    g(this, "_dotLottieCore", null);
    g(this, "_renderConfig", {});
    g(this, "_isFrozen", false);
    g(this, "_backgroundColor", null);
    g(this, "_pointerUpMethod");
    g(this, "_pointerDownMethod");
    g(this, "_pointerMoveMethod");
    g(this, "_pointerEnterMethod");
    g(this, "_pointerExitMethod");
    g(this, "_onCompleteMethod");
    var i, o, p;
    this._canvas = n.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new l1(), this._frameManager = new O1(), this._renderConfig = z(k({}, n.renderConfig), { devicePixelRatio: ((i = n.renderConfig) == null ? void 0 : i.devicePixelRatio) || o1(), freezeOnOffscreen: (p = (o = n.renderConfig) == null ? void 0 : o.freezeOnOffscreen) != null ? p : true }), a1.load().then((_) => {
      var F, P, x, S, M1, q, Z;
      E2._wasmModule = _, this._dotLottieCore = new _.DotLottiePlayer({ autoplay: (F = n.autoplay) != null ? F : false, backgroundColor: 0, loopAnimation: (P = n.loop) != null ? P : false, mode: p2((x = n.mode) != null ? x : "forward", _), segment: m2((S = n.segment) != null ? S : [], _), speed: (M1 = n.speed) != null ? M1 : 1, useFrameInterpolation: (q = n.useFrameInterpolation) != null ? q : true, marker: (Z = n.marker) != null ? Z : "", layout: n.layout ? { align: f2(n.layout.align, _), fit: v2(n.layout.fit, _) } : _.createDefaultLayout() }), this._eventManager.dispatch({ type: "ready" }), n.data ? this._loadFromData(n.data) : n.src && this._loadFromSrc(n.src), n.backgroundColor && this.setBackgroundColor(n.backgroundColor);
    }).catch((_) => {
      this._eventManager.dispatch({ type: "loadError", error: new Error(`Failed to load wasm module: ${_}`) });
  ...
  _fetchData(n) {
    return b(this, null, function* () {
      ...
      return c2(o) ? o : new TextDecoder().decode(o);
    });
  }
  _loadFromData(n) {
    if (this._dotLottieCore === null)
      return;
    let i = this._canvas.width, o = this._canvas.height, p = false;
    if (typeof n == "string") {
      if (!h2(n)) {
        this._dispatchError("Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.");
        return;
      }
      p = this._dotLottieCore.loadAnimationData(n, i, o);
  ...
  get layout() {
    ...
    if (n)
      return { align: [n.align.get(0), n.align.get(1)], fit: (() => {
        var o, p, _, F, P, x;
        switch (n.fit) {
          case ((o = E2._wasmModule) == null ? void 0 : o.Fit.Contain):
            return "contain";
          case ((p = E2._wasmModule) == null ? void 0 : p.Fit.Cover):
            return "cover";
          case ((_ = E2._wasmModule) == null ? void 0 : _.Fit.Fill):
            return "fill";
          case ((F = E2._wasmModule) == null ? void 0 : F.Fit.FitHeight):
            return "fit-height";
          case ((P = E2._wasmModule) == null ? void 0 : P.Fit.FitWidth):
            return "fit-width";
          case ((x = E2._wasmModule) == null ? void 0 : x.Fit.None):
            return "none";
          default:
            return "contain";
        }
  ...
  get mode() {
    ...
    return n === ((o = E2._wasmModule) == null ? void 0 : o.Mode.Reverse) ? "reverse" : n === ((p = E2._wasmModule) == null ? void 0 : p.Mode.Bounce) ? "bounce" : n === ((_ = E2._wasmModule) == null ? void 0 : _.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(n) {
    var i, o, p, _, F, P, x, S;
    this._dotLottieCore === null || E2._wasmModule === null || (this._dotLottieCore.setConfig({ autoplay: (i = n.autoplay) != null ? i : false, backgroundColor: 0, loopAnimation: (o = n.loop) != null ? o : false, mode: p2((p = n.mode) != null ? p : "forward", E2._wasmModule), segment: m2((_ = n.segment) != null ? _ : [], E2._wasmModule), speed: (F = n.speed) != null ? F : 1, useFrameInterpolation: (P = n.useFrameInterpolation) != null ? P : true, marker: (x = n.marker) != null ? x : "", layout: n.layout ? { align: f2(n.layout.align, E2._wasmModule), fit: v2(n.layout.fit, E2._wasmModule) } : E2._wasmModule.createDefaultLayout() }), n.data ? this._loadFromData(n.data) : n.src && this._loadFromSrc(n.src), this.setBackgroundColor((S = n.backgroundColor) != null ? S : ""));
  }
  _render() {
    if (this._dotLottieCore === null || this._context === null)
      return false;
    if (this._dotLottieCore.render()) {
      let i = this._dotLottieCore.buffer(), o = new Uint8ClampedArray(i, 0, this._canvas.width * this._canvas.height * 4), p = null;
      return typeof ImageData == "undefined" ? (p = this._context.createImageData(this._canvas.width, this._canvas.height), p.data.set(o)) : p = new ImageData(o, this._canvas.width, this._canvas.height), this._context.putImageData(p, 0, 0), this._eventManager.dispatch({ type: "render", currentFrame: this._dotLottieCore.currentFrame() }), true;
    }
    return false;
  }
  _draw() {
  ...
  setSpeed(n) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { speed: n }));
  }
  setBackgroundColor(n) {
    this._dotLottieCore !== null && (R && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = n : this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { backgroundColor: o3(n) })), this._backgroundColor = n);
  }
  setLoop(n) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { loopAnimation: n }));
  }
  setUseFrameInterpolation(n) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { useFrameInterpolation: n }));
  }
  addEventListener(n, i) {
  ...
  destroy() {
    var n;
    R && this._canvas instanceof HTMLCanvasElement && (U.unobserve(this._canvas), B.unobserve(this._canvas)), (n = this._dotLottieCore) == null || n.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  resize() {
    ...
    if (R && this._canvas instanceof HTMLCanvasElement) {
      let i = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: o, width: p } = this._canvas.getBoundingClientRect();
      this._canvas.width = p * i, this._canvas.height = o * i;
    }
    this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && this._render();
  }
  setSegment(n, i) {
    this._dotLottieCore === null || E2._wasmModule === null || this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { segment: m2([n, i], E2._wasmModule) }));
  }
  setMode(n) {
    this._dotLottieCore === null || E2._wasmModule === null || this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { mode: p2(n, E2._wasmModule) }));
  }
  setRenderConfig(n) {
    let _ = n, { devicePixelRatio: i, freezeOnOffscreen: o } = _, p = R1(_, ["devicePixelRatio", "freezeOnOffscreen"]);
    this._renderConfig = z(k(k({}, this._renderConfig), p), { devicePixelRatio: i || o1(), freezeOnOffscreen: o != null ? o : true }), R && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? B.observe(this._canvas, this) : B.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? U.observe(this._canvas, this) : (U.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(n) {
  ...
  setMarker(n) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { marker: n }));
  }
  markers() {
    var i;
    ...
    if (n) {
      let o = [];
      for (let p = 0; p < n.size(); p += 1) {
        let _ = n.get(p);
        o.push({ name: _.name, time: _.time, duration: _.duration });
      }
      return o;
    }
    return [];
  ...
  setLayout(n) {
    this._dotLottieCore === null || E2._wasmModule === null || this._dotLottieCore.setConfig(z(k({}, this._dotLottieCore.config()), { layout: { align: f2(n.align, E2._wasmModule), fit: v2(n.fit, E2._wasmModule) } }));
  }
  setViewport(n, i, o, p) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(n, i, o, p);
  }
  static setWasmUrl(n) {
    a1.setWasmUrl(n);
  }
  loadStateMachine(n) {
    var i, o;
    return (o = (i = this._dotLottieCore) == null ? void 0 : i.loadStateMachine(n)) != null ? o : false;
  }
  startStateMachine() {
    var i, o;
    let n = (o = (i = this._dotLottieCore) == null ? void 0 : i.startStateMachine()) != null ? o : false;
    return n && this._setupStateMachineListeners(), n;
  }
  stopStateMachine() {
    var i, o;
    let n = (o = (i = this._dotLottieCore) == null ? void 0 : i.stopStateMachine()) != null ? o : false;
    return n && this._cleanupStateMachineListeners(), n;
  }
  _getPointerPosition(n) {
    let i = this._canvas.getBoundingClientRect(), o = this._canvas.width / i.width, p = this._canvas.height / i.height, _ = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, F = (n.clientX - i.left) * o / _, P = (n.clientY - i.top) * p / _;
    return { x: F, y: P };
  }
  _onPointerUp(n) {
    let { x: i, y: o } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerUp: ${i} ${o}`);
  }
  _onPointerDown(n) {
    let { x: i, y: o } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerDown: ${i} ${o}`);
  }
  _onPointerMove(n) {
    let { x: i, y: o } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerMove: ${i} ${o}`);
  }
  _onPointerEnter(n) {
    let { x: i, y: o } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerEnter: ${i} ${o}`);
  }
  _onPointerLeave(n) {
    let { x: i, y: o } = this._getPointerPosition(n);
    this.postStateMachineEvent(`OnPointerExit: ${i} ${o}`);
  }
  _onComplete() {
  ...
  postStateMachineEvent(n) {
    var o, p;
    let i = (p = (o = this._dotLottieCore) == null ? void 0 : o.postEventPayload(n)) != null ? p : 1;
...
var W1 = class {
  constructor() {
    g(this, "_workers", /* @__PURE__ */ new Map());
    g(this, "_animationWorkerMap", /* @__PURE__ */ new Map());
  }
  getWorker(n) {
  ...
  sendMessage(n, i, o) {
    this.getWorker(n).postMessage(i, o || []);
  }
  terminateWorker(n) {
...
function u3(v) {
  ...
  let { height: n, width: i } = v.getBoundingClientRect();
...
var G = class G2 {
  ...
  _create(n) {
    return b(this, null, function* () {
      ...
      let { instanceId: o } = yield this._sendMessage("create", k({ instanceId: this._id, config: z(k({}, n), { canvas: i }) }, u3(this._canvas)), [i]);
      if (o !== this._id)
  ...
  play() {
    return b(this, null, function* () {
      this._created && (yield this._sendMessage("play", { instanceId: this._id }), yield this._updateDotLottieInstanceState(), R && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !z1(this._canvas) && (yield this.freeze()));
    });
  }
  pause() {
    return b(this, null, function* () {
  ...
  setRenderConfig(n) {
    return b(this, null, function* () {
      if (!this._created)
        return;
      let _ = n, { devicePixelRatio: i, freezeOnOffscreen: o } = _, p = R1(_, ["devicePixelRatio", "freezeOnOffscreen"]);
      yield this._sendMessage("setRenderConfig", { instanceId: this._id, renderConfig: z(k(k({}, this._dotLottieInstanceState.renderConfig), p), { devicePixelRatio: i || o1(), freezeOnOffscreen: o != null ? o : true }) }), yield this._updateDotLottieInstanceState(), R && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? B.observe(this._canvas, this) : B.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? U.observe(this._canvas, this) : (U.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && (yield this.unfreeze())));
    });
  }
  setUseFrameInterpolation(n) {
    return b(this, null, function* () {
  ...
  resize() {
    return b(this, null, function* () {
      if (!this._created)
        return;
      let { height: n, width: i } = u3(this._canvas);
      yield this._sendMessage("resize", { height: n, instanceId: this._id, width: i }), yield this._updateDotLottieInstanceState();
    });
  }
  destroy() {
    return b(this, null, function* () {
      this._created && (this._created = false, yield this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), G2._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), R && this._canvas instanceof HTMLCanvasElement && (U.unobserve(this._canvas), B.unobserve(this._canvas)));
    });
  }
  freeze() {
    return b(this, null, function* () {
  ...
  setViewport(n, i, o, p) {
    return b(this, null, function* () {
      return this._created ? this._sendMessage("setViewport", { x: n, y: i, width: o, height: p, instanceId: this._id }) : false;
    });
  }
  _sendMessage(n, i, o) {
    return b(this, null, function* () {
      let p = { id: `dotlottie-request-${l3()}`, method: n, params: i };
      return this._worker.postMessage(p, o || []), new Promise((_, F) => {
        let P = (x) => {
          let S = x.data;
          S.id === p.id && (this._worker.removeEventListener("message", P), S.error ? F(new Error(`Failed to execute method ${n}: ${S.error}`)) : _(S.result));
        };
        this._worker.addEventListener("message", P);
      });
    });
  }
  addEventListener(n, i) {
  ...
  _getPointerPosition(n) {
    let i = this._canvas.getBoundingClientRect(), o = this._canvas.width / i.width, p = this._canvas.height / i.height, _ = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, F = (n.clientX - i.left) * o / _, P = (n.clientY - i.top) * p / _;
    return { x: F, y: P };
  }
  _onPointerUp(n) {
    let { x: i, y: o } = this._getPointerPosition(n);
...
g(G, "_workerManager", new W1()), g(G, "_wasmUrl", "");
var c3 = G;
